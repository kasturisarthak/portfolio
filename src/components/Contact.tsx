    ...
    <section id="contact" className="section-padding">
      <div className="max-w-4xl mx-auto">
        <h2 className="text-3xl font-bold mb-2 text-center">
          <span className="text-primary font-mono text-xl">07.</span> Contact
        </h2>
        ...
        <div className="max-w-xl mx-auto space-y-6 animate-fade-in text-center">
          ...
          <Button className="bg-primary text-primary-foreground hover:bg-primary/90 w-full md:w-auto mt-6">
